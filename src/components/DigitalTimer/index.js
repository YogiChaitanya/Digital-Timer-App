...
class DigitalTimer extends Component {
      ...
      <div className="minutes-controller">
        ...
        <div className="minutes-card">
          ...
          <div className="set-timer">
            <p className="timer-controller-label">{timerLimitInMinutes}</p>
          </div>
          <button
  ...
  render() {
    const {isTimmerRunning, timeElapsedInSeconds, timerLimitInMinutes} =
      this.state
    const labelTest = isTimmerRunning ? 'Running' : 'Paused'
    return (
